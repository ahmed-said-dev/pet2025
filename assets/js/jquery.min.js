!(function (e, t) {
        ...
        if (!r && (T(t), (t = t || C), E)) {
          ...
          if (
            ...
            if (((l = e), (c = t), 1 === f && (re.test(e) || ne.test(e)))) {
              for (
                ((c = (ce.test(e) && ye(t.parentNode)) || t) === t &&
                  p.scope) ||
                  ((a = t.getAttribute("id"))
                    ? (a = a.replace(fe, M))
        ...
        for (
          var r,
            ...
            c = [
              function (e, t, n) {
                e =
                  (!o && (n || t !== w)) || ((r = t).nodeType ? u : l)(e, t, n);
                return (r = null), e;
              },
            ];
          s < i;
  ...
  (E.filter = function (e, t, n) {
    ...
    E.fn.extend({
      ...
      is: function (e) {
        return !!K(this, "string" == typeof e && Q.test(e) ? E(e) : e || [], !1)
          .length;
      },
    });
  var Z,
        ...
        E.fn[r] = function (e, t) {
          ...
          return (
            (t = "Until" !== r.slice(-5) ? e : t) &&
              ...
              (n = E.filter(t, n)),
            1 < this.length &&
              (ne[r] || E.uniqueSort(n), te.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  w.getRootNode &&
    (k = function (e) {
      return (
        E.contains(e.ownerDocument, e) || e.getRootNode(ve) === e.ownerDocument
      );
    });
  function xe(e, t, n, r) {
    var i,
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            we.test(e.type) && e.click && u(e, "input") && De(e, "click", a), !1
          );
        },
        trigger: function (e) {
          e = this || e;
  ...
  function D(n, r, i, o) {
    ...
    if (
      ...
      for (s = (a = E.map(j(e, "script"), Pe)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = E.clone(u, !0, !0)), s && E.merge(a, j(u, "script"))),
          i.call(n[c], u, c);
      if (s)
        for (l = a[a.length - 1].ownerDocument, E.map(a, Re), c = 0; c < s; c++)
          (u = a[c]),
            Ce.test(u.type || "") &&
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (E.cleanData(j(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return D(
          ...
          function (e) {
            ...
            E.inArray(this, n) < 0 &&
              (E.cleanData(j(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function lt(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += E.css(e, n + p[a], !0, i)),
        r
          ? ("content" === n && (u -= E.css(e, "padding" + p[a], !0, i)),
            "margin" !== n && (u -= E.css(e, "border" + p[a] + "Width", !0, i)))
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = rt(s)), (a = E.cssHooks[t] || E.cssHooks[s]), void 0 === n)
        )
      ...
      _default: {
        ...
        set: function (e) {
          E.fx.step[e.prop]
            ? E.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!E.cssHooks[e.prop] && null == e.elem.style[rt(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function H(i, e, t) {
    ...
    for (; c < f; c++)
      if ((n = H.prefilters[c].call(h, i, g, h.opts)))
        return (
          v(n.stop) &&
            (E._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)),
          n
        );
    return (
      E.map(g, mt, h),
        ...
        if (
          ...
          try {
            (i.href = h.url),
              (i.href = i.href),
              (h.crossDomain =
                $t.protocol + "//" + $t.host != i.protocol + "//" + i.host);
          } catch (e) {
            h.crossDomain = !0;
          }
        }
    ...
    Qt =
      ...
      (E.offset = {
        setOffset: function (e, t, n) {
          ...
          "static" === s && (e.style.position = "relative"),
            ...
            null != (t = v(t) ? t.call(e, n, E.extend({}, o)) : t).top &&
              (l.top = t.top - o.top + i),
      ...
      E.each(["top", "left"], function (e, n) {
        E.cssHooks[n] = Je(y.pixelPosition, function (e, t) {
          if (t)
            return (t = Qe(e, n)), Ge.test(t) ? E(e).position()[n] + "px" : t;
        });
      }),
