              ...
              (s =
                i > o.slideCount
                  ? ((o.slideOffset =
                      ...
                      o.slideWidth *
                      -1),
                    (o.options.slidesToShow - (i - o.slideCount)) * e * -1)
                  : ((o.slideOffset =
        ...
        !0 === s.options.centerMode
          ? ((t = s.options.slidesToShow % 2 == 0 ? 1 : 0),
            ...
            !0 === s.options.infinite &&
              ((o <= i && i <= s.slideCount - 1 - o
                ? s.$slides.slice(i - o + t, i + o + 1)
                : ((e = s.options.slidesToShow + i),
                  n.slice(e - o + 1 + t, e + o + 2))
              )
          ...
          : (0 <= i && i <= s.slideCount - s.options.slidesToShow
              ...
              : ((t = s.slideCount % s.options.slidesToShow),
                (e =
                  !0 === s.options.infinite ? s.options.slidesToShow + i : i),
                s.options.slidesToShow == s.options.slidesToScroll &&
                s.slideCount - i < s.options.slidesToShow
                  ? n.slice(e - (s.options.slidesToShow - t), e + t)
      ...
      (e = e || !1),
        (!0 === r.animating && !0 === r.options.waitForAnimate) ||
          ...
          (!1 === r.options.infinite &&
            ...
            (i < 0 || i > r.getDotCount() * r.options.slidesToScroll)) ||
          (!1 === r.options.infinite &&
