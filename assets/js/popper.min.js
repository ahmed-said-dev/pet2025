...
!(function (e, t) {
  ...
  function m(e) {
    return { scrollLeft: (e = g(e)).pageXOffset, scrollTop: e.pageYOffset };
  }
  function b(e) {
  ...
  function x(e) {
    return (
      (b(e) ? e.ownerDocument : e.document) || window.document
    ).documentElement;
  }
  function h(e) {
    return y(x(e)).left + m(e).scrollLeft;
  }
  function O(e) {
  ...
  function D(e) {
    return "html" === w(e)
      ? e
      : e.assignedSlot || e.parentNode || (o(e) ? e.host : null) || x(e);
  }
  function L(e, t) {
    void 0 === t && (t = []);
    var n,
      o = (function e(t) {
        return 0 <= ["html", "body", "#document"].indexOf(w(t))
    ...
    return (
      (e = o === (null == (n = e.ownerDocument) ? void 0 : n.body)),
      (n = g(o)),
  ...
  function P(e) {
    ...
    if (
      n &&
      ("html" === w(n) || ("body" === w(n) && "static" === O(n).position))
    )
      return t;
    if (!n)
      e: {
    ...
    return (
      "viewport" === t
        ? ((t = g(e)),
          ...
          (e = A((e = { width: n, height: o, x: r + h(e), y: i }))))
        : v(t)
        ? (((e = y(t)).top += t.clientTop),
          (e.left += t.clientLeft),
        ...
        : ((i = x(e)),
          ...
          (n = -n.scrollTop),
          "rtl" === O(t || e).direction &&
            (i += C(e.clientWidth, t ? t.clientWidth : 0) - o),
          (e = A({ width: o, height: r, x: i, y: n }))),
      e
    );
  }
  function B(e) {
  ...
  function T(e) {
    var t = e.reference,
      ...
      r = ((e = e ? e.split("-")[1] : null), t.x + t.width / 2 - n.width / 2),
  ...
  function R(e, t) {
    t =
      void 0 === (t = (u = t = void 0 === t ? {} : t).placement)
        ? e.placement
        : t;
    var n,
      o,
      ...
      s,
      f,
      p = void 0 === (l = u.boundary) ? "clippingParents" : l,
      c = void 0 === (l = u.rootBoundary) ? "viewport" : l,
      l = void 0 === (l = u.elementContext) ? "popper" : l,
      d = void 0 !== (h = u.altBoundary) && h,
      u = H(
        "number" != typeof (u = void 0 === (u = u.padding) ? 0 : u)
          ? u
          : I(u, q)
      ),
      ...
      c =
        ((n = b(
          (d = e.elements[d ? ("popper" === l ? "reference" : "popper") : l])
        )
          ? d
          : d.contextElement || x(e.elements.popper)),
        (r = c),
        (o =
          "clippingParents" === (o = p)
            ? ((a = L(D((i = n)))),
              b(
                (s =
                  0 <= ["absolute", "fixed"].indexOf(O(i).position) && v(i)
                    ? P(i)
                    : i)
              )
                ? a.filter(function (e) {
                    return b(e) && k(e, s) && "body" !== w(e);
                  })
                : [])
            : [].concat(o)),
        ...
        (h = A(Object.assign({}, h, d))),
        "popper" === l ? h : c),
      g = {
        top: p.top - c.top + u.top,
        bottom: c.bottom - p.bottom + u.bottom,
        left: p.left - c.left + u.left,
        right: c.right - p.right + u.right,
      };
    return (
  ...
  function t(e) {
    var t = (e = void 0 === e ? {} : e).defaultModifiers,
      f = void 0 === t ? [] : t,
      p = void 0 === (e = e.defaultOptions) ? Y : e;
            ...
            return (
              ...
              l.orderedModifiers.forEach(function (e) {
                ...
                "function" == typeof (e = e.effect) &&
                  ((t = e({ state: l, name: t, instance: u, options: n })),
                  s.push(t || function () {}));
              }),
              u.update()
            );
                ...
                for (
                  l.rects = {
                    reference:
                      ((r = o),
                      (i = P(n)),
                      void 0 === (a = "fixed" === l.options.strategy) &&
                        (a = !1),
                      (s = x(i)),
                      (r = y(r)),
                      (f = v(i)),
                    ...
                    o = 0;
                  o < l.orderedModifiers.length;
                  o++
                )
                  !0 === l.reset
                    ? ((l.reset = !1), (o = -1))
                    : ((n = (t = l.orderedModifiers[o]).fn),
                      (e = void 0 === (e = t.options) ? {} : e),
                      (t = t.name),
                      "function" == typeof n &&
                        (l =
                          n({ state: l, options: e, name: t, instance: u }) ||
                          l));
            }
            var r, i, a, s, f, p, c;
          },
  ...
  function p(e) {
    ...
    return (
      l &&
        ...
        (r = "clientWidth"),
        (n = P(i)) === g(i) &&
          "static" !== O((n = x(i))).position &&
          ((o = "scrollHeight"), (r = "scrollWidth")),
        "top" === s &&
          ((m = "bottom"), (t = (t - (n[o] - a.height)) * (c ? 1 : -1))),
        "left" === s &&
          ((u = "right"), (e = (e - (n[r] - a.width)) * (c ? 1 : -1)))),
      (i = Object.assign({ position: p }, l && G)),
      c
        ? Object.assign(
            {},
            i,
  ...
  var q = ["top", "bottom", "right", "left"],
    ...
    F = [].concat(q, ["auto"]).reduce(function (e, t) {
    ...
    s = {
      ...
      effect: function (e) {
        ...
        return (
          Object.assign(o.elements.popper.style, r.popper),
          (o.styles = r),
          ...
          function () {
            Object.keys(o.elements).forEach(function (e) {
              var t = o.elements[e],
                n = o.attributes[e] || {};
              (e = Object.keys(
                (o.styles.hasOwnProperty(e) ? o.styles : r)[e]
              ).reduce(function (e, t) {
                return (e[t] = ""), e;
              }, {})),
                v(t) &&
    ...
    Q = {
      ...
      fn: function (e) {
        var t,
          ...
          l = e.state,
          o = e.options;
        if (((e = e.name), !l.modifiersData[e]._skip)) {
          var r = void 0 === (r = o.mainAxis) || r,
            ...
            o = l.rects.reference,
            c = ((a = l.rects.popper), new Map());
          f = !0;
          for (var y = p[0], b = 0; b < p.length; b++) {
            var v = p[b],
              w = M(v),
              x = "start" === v.split("-")[1],
    ...
    Z = {
      ...
      fn: function (e) {
        ...
        var o,
          ...
          c,
          l,
          d = void 0 === (m = n.mainAxis) || m,
          u = void 0 !== (m = n.altAxis) && m,
          m = void 0 === (m = n.tether) || m,
          h = n.tetherOffset,
          g = void 0 === h ? 0 : h,
          y = R(t, {
            boundary: n.boundary,
        ...
        h &&
          ((d || u) &&
            ((o = "y" === w ? "height" : "width"),
            (r = h[w]),
            (i = h[w] + y[(c = "y" === w ? "top" : "left")]),
            (a = h[w] - y[(l = "y" === w ? "bottom" : "right")]),
            (s = m ? -O[o] / 2 : 0),
            (f = ("start" === b ? x : O)[o]),
            (b = "start" === b ? -O[o] : -x[o]),
            (O = t.elements.arrow),
            (O = m && O ? E(O) : { width: 0, height: 0 }),
            (c = (p = t.modifiersData["arrow#persistent"]
              ? t.modifiersData["arrow#persistent"].padding
              : { top: 0, right: 0, bottom: 0, left: 0 })[c]),
            (l = p[l]),
            (O = C(0, N(x[o], O[o]))),
            (f = v ? x[o] / 2 - s - O - c - j : f - O - c - j),
            (x = v ? -x[o] / 2 + s + O + l + j : b + O + l + j),
            ...
            d &&
              ...
              (g[w] = d - r)),
            u &&
              ((d = (u = h[n]) + y["x" === w ? "top" : "left"]),
              (y = u - y["x" === w ? "bottom" : "right"]),
              (d = m ? N(d, v) : d),
              (m = m ? C(y, x) : y),
              (m = C(d, N(u, m))),
              (h[n] = m),
        ...
        (e = B(c)),
          ...
          f &&
            ...
            (p =
              ...
              t[c] / 2 +
              (r / 2 - p / 2)),
            (c = C(s[n], N(p, f - t[c] - s[o]))),
            (i.modifiersData[a] =
              (((r = {})[e] = c), (r.centerOffset = c - p), r)));
      },
      effect: function (e) {
        var t = e.state;
        null !=
    ...
    te = t({ defaultModifiers: [n, i, a, s] }),
    ne = [n, i, a, s, u, Q, Z, $, ee],
    oe = t({ defaultModifiers: ne });
  (e.applyStyles = s),
    (e.arrow = $),
    (e.computeStyles = a),
    (e.createPopper = oe),
    (e.createPopperLite = te),
    (e.defaultModifiers = ne),
    (e.detectOverflow = R),
    (e.eventListeners = n),
    (e.flip = Q),
    (e.hide = ee),
