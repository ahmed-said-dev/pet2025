...
!(function (e, t) {
  ...
  function ScrollSmoother(e) {
    ...
    function Ka(t, r, n, o) {
      return function () {
        ...
        return (
          e ||
            0 === e ||
            (e = o.getAttribute("data-" + A + t) || ("speed" === t ? 1 : 0)),
    ...
    function La(r, e, t, n) {
      ...
      function Ab() {
        (g.y = h + "px"), g.renderTransform(1), zb();
      }
      function Eb(e) {
        if (a) {
          Ab();
              ...
              onUpdate: function onUpdate(e) {
                ...
                if (e.offset) {
                  ...
                  (o = (function _round(e) {
                    ...
                    l
                      ? (l.resetTo("y", o, -R, !0), H && l.progress(1))
    ...
    Ha(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? u
            ? I.to(o, { duration: P, scrollTop: n, overwrite: "auto", ease: j })
            : k(n)
          : Ca(n);
      }),
      (this.offset = function (e, t) {
        var r,
          ...
          o = D.create({ trigger: e, start: t || "top top" });
        return (
          b && Fa([o]),
          (r = o.start),
          o.kill(!1),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              P || I.set(n, { clearProps: "transform" })),
            this
          );
        }
        return n;
        ...
        return arguments.length
          ? ((m =
              ...
              (function _wrap(e) {
                ...
                return (
                  t ||
                    ((t = O.createElement("div")).classList.add(
      ...
      (this.effects = function (e, t) {
        ...
        var r,
          ...
          i = t.lag,
          s = [];
        for (r = 0; r < e.length; r++) (n = La(e[r], o, i, r)) && s.push(n);
    ...
    F.forEach(function (e) {
        ...
        animation: I.fromTo(
          ...
          { y: 0 },
          {
            ...
            onUpdate: function onUpdate() {
              if (this._dur) {
                var e = g;
                e && (Aa(i), (z.y = _)), Ba(z.y, e), wa(), v && !u && v(x);
              }
            },
          }
        ),
      ...
      (this.kill = this.revert =
        function () {
          ...
          D.scrollerProxy(m),
            ...
            (n.style.cssText = c);
          var r = D.defaults({});
          r && r.scroller === m && D.defaults({ scroller: L }),
      ...
      E &&
        (this.normalizer = D.normalizeScroll(
          !0 === E ? { debounce: !0, content: !P && n } : E
        )),
      D.config(e),
      "overscrollBehavior" in L.getComputedStyle(K) &&
        I.set([K, U], { overscrollBehavior: "none" }),
      "scrollBehavior" in L.getComputedStyle(K) &&
        I.set([K, U], { scrollBehavior: "auto" }),
