!(function (t, e) {
  ...
  const g = {
          ...
          s =
            s && r(s)
              ...
              : {}.toString
                  ...
                  .match(/\s([a-z]+)/i)[1]
                  .toLowerCase();
        if (!new RegExp(e).test(s))
          throw new TypeError(
            i.toUpperCase() +
              `: Option "${t}" provided type "${s}" but expected type "${e}".`
          );
      });
    },
    h = (t) =>
    ...
    z = (s, n, t = !0) => {
      if (t) {
        ...
        const i = ({ target: t }) => {
          t === n &&
            ((e = !0), n.removeEventListener("transitionend", i), f(s));
        };
  ...
  function tt(s, i, n = null) {
    var o = Object.keys(s);
    for (let t = 0, e = o.length; t < e; t++) {
      var a = s[o[t]];
      if (a.originalHandler === i && a.delegationSelector === n) return a;
    }
    return null;
  }
  function et(t, e, s) {
    var i = "string" == typeof e,
      s = i ? s : e;
    let n = nt(t);
    return [i, s, (n = G.has(n) ? n : t)];
  }
  function st(t, e, s, i, n) {
    if ("string" == typeof e && t) {
      if ((s || ((s = i), (i = null)), Y.test(e))) {
        const t = (e) =>
          function (t) {
            if (
              !t.relatedTarget ||
      ...
      const [h, d, u] = et(e, s, i),
        g = J(t),
        p = g[u] || (g[u] = {}),
        m = tt(p, d, h ? s : null);
      if (m) return (m.oneOff = m.oneOff && n);
      const f = Z(d, e.replace(F, "")),
        _ = h
          ? ((r = t),
            (l = s),
            (c = i),
          ...
          : ((o = t),
            ...
            function t(e) {
              return (
                (e.delegateTarget = o),
                t.oneOff && b.off(o, e.type, a),
                a.apply(o, [e])
              );
            });
      var o, a, r, l, c;
      (_.delegationSelector = h ? s : null),
        (_.originalHandler = d),
        (_.oneOff = n),
        (_.uidEvent = f),
        (p[f] = _),
        t.addEventListener(u, _, h);
    }
  }
  function it(t, e, s, i, n) {
    i = tt(e[s], i, n);
    i && (t.removeEventListener(s, i, Boolean(n)), delete e[s][i.uidEvent]);
  }
  function nt(t) {
    return (t = t.replace(U, "")), X[t] || t;
  }
  const b = {
      on(t, e, s, i) {
        st(t, e, s, i, !1);
      ...
      off(a, r, t, e) {
        if ("string" == typeof r && a) {
          const [s, i, n] = et(r, t, e),
            o = n !== r,
            l = J(a),
            c = r.startsWith(".");
          if (void 0 !== i)
            return l && l[n] ? void it(a, l, n, i, s ? t : null) : void 0;
          c &&
            Object.keys(l).forEach((t) => {
              {
                ...
                Object.keys(o).forEach((t) => {
                  if (t.includes(n)) {
                    const n = o[t];
                    it(e, s, i, n.originalHandler, n.delegationSelector);
                  }
                });
              }
            });
          ...
          Object.keys(h).forEach((t) => {
            ...
            if (!o || r.includes(e)) {
              const r = h[t];
              it(a, l, n, r.originalHandler, r.delegationSelector);
            }
          });
        }
      },
  ...
  var v = function (t, e, s) {
    ...
    ot = (t, e) => (_.has(t) && _.get(t).get(e)) || null,
    at = function (t, e) {
      if (_.has(t)) {
        const s = _.get(t);
        s.delete(e), 0 === s.size && _.delete(t);
      }
    };
  class y {
    constructor(t) {
      (t = o(t)) &&
        ((this._element = t),
        v(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class E extends y {
    ...
    close(t) {
      var t = t ? this._getRootElement(t) : this._element,
  ...
  const A = {
      setDataAttribute(t, e, s) {
        t.setAttribute("data-bs-" + lt(e), s);
      },
      removeDataAttribute(t, e) {
        t.removeAttribute("data-bs-" + lt(e));
      },
      getDataAttributes(s) {
        if (!s) return {};
        const i = {};
      ...
      getDataAttribute: (t, e) => rt(t.getAttribute("data-bs-" + lt(e))),
      offset(t) {
  ...
  class O extends y {
    ...
    to(t) {
      ...
      t > this._items.length - 1 ||
        t < 0 ||
        (this._isSliding
          ? b.one(this._element, "slid.bs.carousel", () => this.to(t))
          : e === t
          ? (this.pause(), this.cycle())
          : ((e = e < t ? T : C), this._slide(e, this._items[t])));
    }
    _getConfig(t) {
      return (
        (t = {
    ...
    _addTouchEventListeners() {
      ...
      g.find(".carousel-item img", this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (b.on(this._element, "pointerdown.bs.carousel", (t) => e(t)),
            b.on(this._element, "pointerup.bs.carousel", (t) => i(t)),
            this._element.classList.add("pointer-event"))
          : (b.on(this._element, "touchstart.bs.carousel", (t) => e(t)),
            b.on(this._element, "touchmove.bs.carousel", (t) => s(t)),
            b.on(this._element, "touchend.bs.carousel", (t) => i(t)));
    }
    _keydown(t) {
      var e;
      /input|textarea/i.test(t.target.tagName) ||
        ((e = dt[t.key]) && (t.preventDefault(), this._slide(e)));
    }
    _getItemIndex(t) {
      return (
        (this._items =
          t && t.parentNode ? g.find(".carousel-item", t.parentNode) : []),
    ...
    _setActiveIndicatorElement(e) {
      if (this._indicatorsElement) {
        const t = g.findOne(".active", this._indicatorsElement),
          s =
            (t.classList.remove("active"),
            t.removeAttribute("aria-current"),
            g.find("[data-bs-target]", this._indicatorsElement));
        for (let t = 0; t < s.length; t++)
          if (
            Number.parseInt(s[t].getAttribute("data-bs-slide-to"), 10) ===
            this._getItemIndex(e)
          ) {
            s[t].classList.add("active"),
              s[t].setAttribute("aria-current", "true");
            break;
          }
      }
    }
    _updateInterval() {
      ...
      var e;
      t &&
        ((e = Number.parseInt(t.getAttribute("data-bs-interval"), 10))
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        i = g.findOne(".active.carousel-item", this._element),
      ...
      if (o && o.classList.contains("active")) this._isSliding = !1;
        ...
        if (this._element.classList.contains("slide")) {
          o.classList.add(h), p(o), i.classList.add(c), o.classList.add(c);
          const t = () => {
            o.classList.remove(c, h),
              o.classList.add("active"),
              i.classList.remove("active", h, c),
              (this._isSliding = !1),
              setTimeout(u, 0);
          };
    ...
    static carouselInterface(t, e) {
      const s = O.getOrCreateInstance(t, e);
      let i = s["_config"];
    ...
    static dataApiClickHandler(t) {
      ...
      if (e && e.classList.contains("carousel")) {
        const s = { ...A.getDataAttributes(e), ...A.getDataAttributes(this) },
          i = this.getAttribute("data-bs-slide-to");
        i && (s.interval = !1),
          O.carouselInterface(e, s),
          i && O.getInstance(e).to(i),
          t.preventDefault();
      }
    }
  }
  b.on(
    ...
    b.on(window, "load.bs.carousel.data-api", () => {
      var s = g.find('[data-bs-ride="carousel"]');
      for (let t = 0, e = s.length; t < e; t++)
        O.carouselInterface(s[t], O.getInstance(s[t]));
    }),
    t(O);
  const ut = { toggle: !0, parent: "" },
  ...
  class D extends y {
    constructor(t, s) {
      super(t),
        ...
        (this._triggerArray = g.find(
          `[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`
        ));
      var i = g.find('[data-bs-toggle="collapse"]');
      for (let t = 0, e = i.length; t < e; t++) {
        const s = i[t],
          n = a(s),
          o = g.find(n).filter((t) => t === this._element);
        null !== n &&
          o.length &&
    ...
    show() {
      if (!this._isTransitioning && !this._element.classList.contains("show")) {
        ...
        if (t) {
          const g = t.find((t) => i !== t);
          if ((e = g ? D.getInstance(g) : null) && e._isTransitioning) return;
        }
        if (!b.trigger(this._element, "show.bs.collapse").defaultPrevented) {
          t &&
            t.forEach((t) => {
              i !== t && D.collapseInterface(t, "hide"),
    ...
    _getConfig(t) {
      return (
        ((t = { ...ut, ...t }).toggle = Boolean(t.toggle)),
        c("collapse", t, gt),
        t
      );
    }
    ...
    _getParent() {
      var t = this._config["parent"],
        e = `[data-bs-toggle="collapse"][data-bs-parent="${(t = o(t))}"]`;
      return (
        g.find(e, t).forEach((t) => {
          var e = n(t);
    ...
    static collapseInterface(t, e) {
      let s = D.getInstance(t);
      const i = {
        ...ut,
        ...A.getDataAttributes(t),
        ...("object" == typeof e && e ? e : {}),
      };
      if (
        (!s &&
  ...
  b.on(
    ...
    function (t) {
      ("A" === t.target.tagName ||
        ...
        t.preventDefault();
      const i = A.getDataAttributes(this),
        e = a(this);
      g.find(e).forEach((t) => {
        const e = D.getInstance(t);
        let s;
        (s = e
          ? (null === e._parent &&
            ...
            "toggle")
          : i),
          D.collapseInterface(t, s);
      });
    }
  ),
    t(D);
  const pt = new RegExp("ArrowUp|ArrowDown|Escape"),
    mt = m() ? "top-end" : "top-start",
    ft = m() ? "top-start" : "top-end",
    _t = m() ? "bottom-end" : "bottom-start",
    bt = m() ? "bottom-start" : "bottom-end",
    vt = m() ? "left-start" : "right-start",
    yt = m() ? "right-start" : "left-start",
    Et = {
      offset: [0, 2],
  ...
  class I extends y {
    ...
    show() {
      if (!d(this._element) && !this._menu.classList.contains("show")) {
        const e = I.getParentFromElement(this._element),
          t = { relatedTarget: this._element };
        if (!b.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
          if (this._inNavbar) A.setDataAttribute(this._menu, "popper", "none");
          else {
            if (void 0 === l)
              throw new TypeError(
            ...
            (this._popper = l.createPopper(t, this._menu, s)),
              i && A.setDataAttribute(this._menu, "popper", "static");
          }
          "ontouchstart" in document.documentElement &&
            !e.closest(".navbar-nav") &&
            []
              .concat(...document.body.children)
              .forEach((t) => b.on(t, "mouseover", u)),
            this._element.focus(),
      ...
      return t.classList.contains("dropend")
        ...
        : ((e =
            ...
            getComputedStyle(this._menu)
              ...
              .trim()),
          t.classList.contains("dropup") ? (e ? ft : mt) : e ? bt : _t);
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      const s = g
        ...
        .filter(h);
      s.length && $(s, e, "ArrowDown" === t, !s.includes(e)).focus();
    }
    static dropdownInterface(t, e) {
      const s = I.getOrCreateInstance(t, e);
      if ("string" == typeof e) {
        if (void 0 === s[e]) throw new TypeError(`No method named "${e}"`);
        s[e]();
      }
    ...
    static clearMenus(s) {
      if (!s || (2 !== s.button && ("keyup" !== s.type || "Tab" === s.key))) {
        const i = g.find('[data-bs-toggle="dropdown"]');
        for (let t = 0, e = i.length; t < e; t++) {
          const g = I.getInstance(i[t]);
          if (
            g &&
            !1 !== g._config.autoClose &&
            g._element.classList.contains("show")
          ) {
            const n = { relatedTarget: g._element };
            if (s) {
              const i = s.composedPath(),
                o = i.includes(g._menu);
              if (
                i.includes(g._element) ||
                ("inside" === g._config.autoClose && !o) ||
                ("outside" === g._config.autoClose && o)
              )
                continue;
              if (
                g._menu.contains(s.target) &&
                (("keyup" === s.type && "Tab" === s.key) ||
                  /input|select|option|textarea|form/i.test(s.target.tagName))
              )
                continue;
              "click" === s.type && (n.clickEvent = s);
            }
            g._completeHide(n);
          }
        }
        ...
        if (s || "Escape" !== t.key)
          if ((t.preventDefault(), t.stopPropagation(), !d(this)))
            return (
              ...
              "Escape" === t.key
                ? (e().focus(), void I.clearMenus())
                : "ArrowUp" === t.key || "ArrowDown" === t.key
                ? (s || e().click(), void I.getInstance(e())._selectMenuItem(t))
                : void ((s && "Space" !== t.key) || I.clearMenus())
            );
      }
    }
  }
  b.on(
    ...
    b.on(document, "click.bs.dropdown.data-api", I.clearMenus),
    b.on(document, "keyup.bs.dropdown.data-api", I.clearMenus),
    b.on(
      document,
      "click.bs.dropdown.data-api",
      '[data-bs-toggle="dropdown"]',
      function (t) {
        t.preventDefault(), I.dropdownInterface(this);
      }
    ),
    t(I);
  class At {
    ...
    _setElementAttributes(t, s, i) {
      const n = this.getWidth();
      this._applyManipulationCallback(t, (t) => {
        var e;
        (t !== this._element && window.innerWidth > t.clientWidth + n) ||
          (this._saveInitialAttribute(t, s),
          (e = window.getComputedStyle(t)[s]),
          (t.style[s] = i(Number.parseFloat(e)) + "px"));
      });
    }
    reset() {
    ...
    _saveInitialAttribute(t, e) {
      var s = t.style[e];
      s && A.setDataAttribute(t, e, s);
    }
    _resetElementAttributes(t, s) {
      this._applyManipulationCallback(t, (t) => {
        var e = A.getDataAttribute(t, s);
        void 0 === e
          ? t.style.removeProperty(s)
          : (A.removeDataAttribute(t, s), (t.style[s] = e));
      });
    }
    _applyManipulationCallback(t, e) {
      r(t) ? e(t) : g.find(t, this._element).forEach(e);
    }
    isOverflowing() {
  ...
  class kt {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Tt, ...("object" == typeof t ? t : {}) }).rootElement = o(
          t.rootElement
        )),
        c("backdrop", t, Ct),
        t
    ...
    _emulateAnimation(t) {
      z(t, this._getElement(), this._config.isAnimated);
    }
  }
  ...
  class N extends y {
    ...
    _showElement(t) {
      const e = this._isAnimated(),
        s = g.findOne(".modal-body", this._dialog);
  ...
  class S extends y {
    ...
    show(t) {
      this._isShown ||
        ...
        this._backdrop.show(),
        this._config.scroll ||
          (new At().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.classList.add("show"),
    ...
    _enforceFocusOnElement(e) {
      b.off(document, "focusin.bs.offcanvas"),
        b.on(document, "focusin.bs.offcanvas", (t) => {
          document === t.target ||
            e === t.target ||
            e.contains(t.target) ||
            e.focus();
  ...
  b.on(
    ...
    b.on(window, "load.bs.offcanvas.data-api", () =>
      g.find(".offcanvas.show").forEach((t) => S.getOrCreateInstance(t).show())
    ),
    t(S);
  const Nt = new Set([
      "background",
    ...
    St = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i,
    xt =
        ...
        r.forEach((t) => {
          ((t, e) => {
            ...
            if (e.includes(s))
              return (
                !Nt.has(s) ||
                Boolean(St.test(t.nodeValue) || xt.test(t.nodeValue))
              );
  ...
  class x extends y {
    ...
    show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        if (!e.defaultPrevented && i) {
          ...
          const a = this._config["container"],
            r =
              (v(n, this.constructor.DATA_KEY, this),
              this._element.ownerDocument.documentElement.contains(this.tip) ||
                (a.appendChild(n),
                b.trigger(this._element, this.constructor.Event.INSERTED)),
              this._popper
                ? this._popper.update()
                : (this._popper = l.createPopper(
                    this._element,
                    n,
    ...
    getTipElement() {
      if (!this.tip) {
        const t = document.createElement("div");
        (t.innerHTML = this._config.template), (this.tip = t.children[0]);
      }
      return this.tip;
    }
    setContent() {
      const t = this.getTipElement();
      this.setElementContent(g.findOne(".tooltip-inner", t), this.getTitle()),
        ...
        return r(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = Mt(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || ot(t.delegateTarget, s)) ||
          ((e = new this.constructor(
            t.delegateTarget,
            this._getDelegateConfig()
          )),
          v(t.delegateTarget, s, e)),
        e
      );
    }
    _getOffset() {
      ...
      this._config.trigger.split(" ").forEach((t) => {
        ...
        "click" === t
          ...
          : "manual" !== t &&
            ...
            b.on(this._element, t, this._config.selector, (t) =>
              this._leave(t)
            ));
      }),
        (this._hideModalHandler = () => {
    ...
    _getConfig(t) {
      ...
      return (
        ...
        t.sanitize && (t.template = Mt(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
    ...
    static jQueryInterface(e) {
      return this.each(function () {
        const t = x.getOrCreateInstance(this, e);
        if ("string" == typeof e) {
          if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
          t[e]();
        }
  ...
  const qt = new RegExp("(^|\\s)bs-popover\\S+", "g"),
    ...
    $t = { ...x.DefaultType, content: "(string|element|function)" },
    Ft = {
    ...
    getTipElement() {
      return (
        this.tip ||
          ...
          this.getTitle() || g.findOne(".popover-header", this.tip).remove(),
          this._getContent() || g.findOne(".popover-body", this.tip).remove()),
        this.tip
      );
    }
    setContent() {
      const t = this.getTipElement();
      this.setElementContent(g.findOne(".popover-header", t), this.getTitle());
      let e = this._getContent();
      "function" == typeof e && (e = e.call(this._element)),
        this.setElementContent(g.findOne(".popover-body", t), e),
        t.classList.remove("fade", "show");
    }
    _addAttachmentClass(t) {
      this.getTipElement().classList.add(
  ...
  t(Ut);
  const Kt = { offset: 10, method: "auto", target: "" },
  ...
  class M extends y {
    ...
    refresh() {
      ...
      (this._offsets = []),
        ...
        g
          ...
          .map((t) => {
            const e = a(t),
              s = e ? g.findOne(e) : null;
            if (s) {
              const t = s.getBoundingClientRect();
              if (t.width || t.height) return [A[i](s).top + n, e];
            }
            return null;
          })
          .filter((t) => t)
    ...
    _getConfig(e) {
      if (
        ...
        let t = e.target["id"];
        t || ((t = H("scrollspy")), (e.target.id = t)), (e.target = "#" + t);
      }
      return c("scrollspy", e, Vt), e;
    }
    _getScrollTop() {
    ...
    _process() {
      const e = this._getScrollTop() + this._config.offset,
        ...
        s = this._config.offset + t - this._getOffsetHeight();
      if ((this._scrollHeight !== t && this.refresh(), e >= s)) {
    ...
    _activate(e) {
      ...
      s.classList.contains("dropdown-item")
        ...
        : (s.classList.add("active"),
          g.parents(s, ".nav, .list-group").forEach((t) => {
            g
              .prev(t, ".nav-link, .list-group-item")
              .forEach((t) => t.classList.add("active")),
              g.prev(t, ".nav-item").forEach((t) => {
                g.children(t, ".nav-link").forEach((t) =>
  ...
  b.on(window, "load.bs.scrollspy.data-api", () => {
    g.find('[data-bs-spy="scroll"]').forEach((t) => new M(t));
  }),
    t(M);
  class P extends y {
    static get NAME() {
    ...
    show() {
      if (
        ...
        b.trigger(this._element, "show.bs.tab", { relatedTarget: t })
          ...
          s ? this._activate(s, s.parentNode, e) : e());
      }
    }
    _activate(t, e, s) {
      const i = (
          !e || ("UL" !== e.nodeName && "OL" !== e.nodeName)
            ? g.children(e, ".active")
            : g.find(":scope > li > .active", e)
        )[0],
        n = s && i && i.classList.contains("fade"),
        o = () => this._transitionComplete(t, i, s);
      i && n
        ? (i.classList.remove("show"), this._queueCallback(o, t, !0))
        : o();
    }
  ...
  b.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        d(this) || P.getOrCreateInstance(this).show();
    }
  ),
    t(P);
